...
class AuthApi {
  ...
  Future<CurrentUser> register({required String email, required String password, required String fullName}) async {
    try {
  ...
  Future<AuthTokens> verifyEmail({required String email, required String code}) async {
    try {
